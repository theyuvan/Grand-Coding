      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl" : "text-2xl"}`}>Event Pass</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              <Link href="/login">Enter as organizer</Link>
            </Button>
          </div>
        ...
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            <Button
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <Link href="/login">Enter as student</Link>
            </Button>
            <Button
              asChild
